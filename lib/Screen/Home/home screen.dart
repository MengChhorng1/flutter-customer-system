        ...
        return products
            .where(
              (p) =>
                  ...
                  p.name.contains("Xiaomi") ||
                  p.name.contains("Google") ||
                  p.name.contains("Sony") ||
                  p.name.contains("Oppo") ||
                  p.name.contains("Realme") ||
                  p.name.contains("ASUS"),
            )
            .toList();
      case 'IPad':
        return products.where((p) => p.name.contains("iPad")).toList();
      case 'Laptop':
        return products
            .where(
              (p) =>
                  p.name.contains("MacBook") ||
                  p.name.contains("Lenovo") ||
                  p.name.contains("Dell") ||
                  p.name.contains("HP"),
            )
            .toList();
      case 'Desktop':
        return products.where((p) => p.name.contains("iMac")).toList();
      default:
        return products;
    }
  }
